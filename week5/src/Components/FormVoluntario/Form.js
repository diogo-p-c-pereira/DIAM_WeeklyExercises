        ...
        <div className="form-container">
            <div>
                <form onSubmit={handleSubmit}>
                    ...
                    <label>Nome:</label>
                    <input required type="text" value={formData.nome} onChange={handleChange}/>
                    <br/>

                    <label>Contacto:</label>
                    <input required type="text" value={formData.contacto} onChange={handleChange}/>
                    <br/>

                    <label>Disponibilidade: </label>
                    <input required type="text" list="horarios" value={formData.horario}
                    ...
                    <textarea value={formData.comentario} onChange={handleChange}></textarea><br/>
